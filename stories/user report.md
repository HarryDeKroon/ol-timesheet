...
The number of days are calculated by taking the (total) number of minutes, divided by the number of hours (may be fractional e.g. 7.5) per day (from the user settings) times 60 and rounded to one decimal.
